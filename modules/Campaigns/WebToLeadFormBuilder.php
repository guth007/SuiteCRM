...
<form action='$webPostUrl' name='WebToLeadForm' method='POST' id='WebToLeadForm'>
    <h2 id="headline">$webFormHeader</h2>
...
<div class="row center buttons">
    <input type="submit" onclick="submit_form();" class="button" name="Submit" value="$webFormSubmitLabel" id="submit" />
    <div class="clear">&nbsp;</div>
</div>
...
const queryString = window.location.search;
   ...
   //document.getElementById('nothx').value = urlParams.get('last_name');
   urlParams.forEach(function(value, key) {
       if (document.getElementById(key)!=null && document.getElementById(key)!='Submit') {
           document.getElementById(key).value = value;
       console.log(value, key);
       }
   });
   if (urlParams.get('dup_checked')==1)
   {

      document.getElementById('headline').innerHTML = 'Thx submitting';
